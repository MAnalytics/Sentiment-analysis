...
```{r figs2, echo=FALSE, fig.cap=fig$cap("figs1", "Data download (by Country)"), out.width = '60%', fig.align="center"} 
knitr::include_graphics("DatacollectionbyCountry.png")
```

```{r figs3, echo=FALSE, fig.cap=fig$cap("figs1", "Data download (by Voting results)"), out.width = '60%', fig.align="center"} 
knitr::include_graphics("DatacollectionbyVoting.png")
```
