...
write_as_csv(all_Tweets, paste("policeTweet_set_", 40, "_.csv", sep=""), na="NA", fileEncoding = "UTF-8")
...
write_as_csv(all_Tweets, paste("only_policeTweet_set_", 40, "_.csv", sep=""), na="NA", fileEncoding = "UTF-8")
