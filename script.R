...
#write_as_csv(all_Tweets, "C:/Users/monsu/Documents/GitHub/Sentiment-analysis/scottishIndy_byCountry_TRIAL15.csv", na="NA", fileEncoding = "UTF-8")
#write.table(uniq_Dates, file="C:/Users/monsu/Documents/GitHub/Sentiment-analysis/scottishIndy_byCountry_uniq_Dates_TRIAL15.csv", sep=",", row.names = F)


write_as_csv(all_Tweets, file="./scottishIndy_byCountry_TRIAL15.csv", na="NA", fileEncoding = "UTF-8")
write.table(uniq_Dates, file="./scottishIndy_byCountry_uniq_Dates_TRIAL15.csv", sep=",", row.names = F)
...
write_as_csv(all_Tweets, file="C:/Users/monsu/Documents/GitHub/Sentiment-analysis/download_byVoting_TRIAL15.csv", na="NA", fileEncoding = "UTF-8")
write.table(uniq_Dates, file="C:/Users/monsu/Documents/GitHub/Sentiment-analysis/download_byVoting_uniq_Dates_TRIAL15.csv", sep=",", row.names = F)
#w
...
#write_as_csv(all_Tweets, "C:/Users/monsu/Documents/GitHub/Sentiment-analysis/download_byCountry_TRIAL15.csv", na="NA", fileEncoding = "UTF-8")
#write.table(uniq_Dates, file="C:/Users/monsu/Documents/GitHub/Sentiment-analysis/download_byCountry_uniq_Dates_TRIAL15.csv", sep=",", row.names = F)
#write_as_csv(tweets_g, "try.csv", na="NA", fileEncoding = "UTF-8")
# 
